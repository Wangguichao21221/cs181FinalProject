    ...
    while not frontier.isEmpty():
        ...
        if currentNode not in expanded:
            ...
            for successor, action, stepcost in problem.getSuccessors(currentNode):
                if successor not in expanded:
                    newPath = path + [action]
                    frontier.update((successor, newPath), problem.getCostOfActions(newPath))
    ...
    while not frontier.isEmpty():
        ...
        if currentNode not in expanded:
            ...
            for successor, action, stepcost in problem.getSuccessors(currentNode):
                if successor not in expanded:
                    newPath = path + [action]
                    frontier.update((successor, newPath), problem.getCostOfActions(newPath)+heuristic(successor, problem))
